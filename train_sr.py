...
parser.add_argument("--pretrained", default=None, help="path to folder containing the model")
parser.add_argument("--train", default="../dataset/Jung/train/", help="path to real train dataset")
parser.add_argument("--test", default="../dataset/Jung/test/", help="path to test dataset")
...
parser.add_argument("--parallel", default=True, action = 'store_true', help = "parallel training")
...
parser.add_argument("--continue_training", default = False, type=bool,  help="search for checkpoint in the subfolder specified by `task` argument")
